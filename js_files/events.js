...
fetch('getEvents.php')
    ...
    .catch(err => {
        console.error(err);
        eventsGrid.innerHTML = "<p style='color:red; text-align:center;'>Failed to load events. Please try again later.</p>";
    });
...
function renderEvents() {
    ...
    filtered.forEach(ev => {
        ...
        // Use image if available, else gradient background
